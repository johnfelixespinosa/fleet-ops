...
8. Write to `/tmp/fleetops-reports/maintenance-investigation-{date}-{unique6}.html`
9. Open in browser: `open /tmp/fleetops-reports/maintenance-investigation-{date}-{unique6}.html`
